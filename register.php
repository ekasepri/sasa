...
<head>
     <meta charset="UTF-8" />
    <title>Sistem Informasi Penjualan Toko Tas | Login Page</title>
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            <form action="proses_tambah_customer.php" method="post" class="form-signin">
				...
				<input type="text" autofocus required name="nama" placeholder="Nama Lengkap" class="form-control" />
                ...
                <input type="text" required name="no_telp" placeholder="Nomor Telepon" class="form-control" /> <br>
